(() => {
  ...
  const SVG = {
    ...
    sparkle: '<svg viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>',
    ...
    check: '<svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true"><path fill="currentColor" d="M14 4.5L6 12.5l-4-4L3 7.5l3 3 7-7z"/></svg>',
  ...
  const state = {
    ...
    language: persisted.language ? (persisted.language === "tr" ? "tr" : "en") : ((navigator.language || "").toLowerCase().startsWith("tr") ? "tr" : "en"),
    error: ""
  };
      ...
      <section class="iu-panel" role="dialog" aria-label="${escapeAttr(t("title"))}">
        <header class="iu-header" data-drag>
          ...
          <div class="iu-header-actions">
            <div class="iu-header-actions-group" style="display: flex; gap: 2px; align-items: center;">
              <a href="https://github.com/talhaeenss/ivy-takibi-birakanlar" target="_blank" rel="noopener noreferrer" title="GitHub" style="display: grid; place-items: center;">${SVG.github}</a>
              <a href="https://talhaeens-ivy.netlify.app/" target="_blank" rel="noopener noreferrer" title="Website" style="display: grid; place-items: center;">${SVG.globe}</a>
  ...
  const CSS = `
    ...
    #${APP_ID} {
      --iu-bg: rgba(9, 9, 15, 0.76);
      --iu-bg-solid: #09090f;
      --iu-bg-2: rgba(0, 102, 255, 0.06);
      --iu-bg-3: rgba(0, 102, 255, 0.12);
      --iu-line: rgba(255, 255, 255, 0.07);
      --iu-line-strong: rgba(255, 255, 255, 0.15);
      --iu-text: #f8fafc;
      --iu-muted: #94a3b8;
      --iu-accent: #0066ff;
      --iu-accent-2: #00d2ff;
      --iu-accent-grad: linear-gradient(135deg, #0052d4 0%, #4364f7 50%, #6fb1fc 100%);
      --iu-danger: #ef4444;
      --iu-success: #10b981;
      --iu-card-bg: rgba(255, 255, 255, 0.02);
      --iu-panel-shadow: -10px 0 50px rgba(0, 0, 0, 0.7), inset 1px 0 0 rgba(255, 255, 255, 0.1);
    ...
    @media (prefers-color-scheme: light) {
      #${APP_ID} {
        --iu-bg: rgba(248, 250, 252, 0.82);
        --iu-bg-solid: #ffffff;
        --iu-bg-2: rgba(79, 70, 229, 0.05);
        --iu-bg-3: rgba(79, 70, 229, 0.09);
        --iu-line: rgba(15, 23, 42, 0.08);
        --iu-line-strong: rgba(15, 23, 42, 0.15);
        --iu-text: #0f172a;
        --iu-muted: #64748b;
        --iu-card-bg: rgba(15, 23, 42, 0.01);
        --iu-panel-shadow: -10px 0 50px rgba(79, 70, 229, 0.05), inset 1px 0 0 rgba(255, 255, 255, 0.6);
      }
    }
    ...
    #${APP_ID} button { cursor: pointer; border: none; background: transparent; }

    /* REDESIGN: FLOATING PANEL TO FULL DOCKED SIDEBAR PANEL */
    #${APP_ID} .iu-panel {
      ...
      border-left: 1px solid var(--iu-line) !important;
      border-radius: 24px 0 0 24px !important;
      box-shadow: var(--iu-panel-shadow);
      overflow: hidden;
      animation: iu-sidebar-slide 0.4s cubic-bezier(0.16, 1, 0.3, 1);
    }

    @keyframes iu-sidebar-slide {
    ...
    #${APP_ID} .iu-header {
      ...
      cursor: default !important; /* disabled drag as it is a fixed sidebar */
      user-select: none;
    ...
    #${APP_ID} .iu-brand-dot {
      ...
      height: 12px;
      border-radius: 50%;
      background: var(--iu-accent-grad);
      flex-shrink: 0;
      box-shadow: 0 0 12px rgba(168, 85, 247, 0.6);
      animation: brandPulse 3s infinite alternate;
    }
    ...
    #${APP_ID} .iu-brand-text strong { display: block; font-size: 15px; font-weight: 800; letter-spacing: -0.02em; }
    #${APP_ID} .iu-brand-text span { display: block; font-size: 10.5px; color: var(--iu-muted); margin-top: 1px; font-weight: 500; }

    #${APP_ID} .iu-header-actions { display: flex; gap: 6px; flex-shrink: 0; }
    #${APP_ID} .iu-header-actions button, #${APP_ID} .iu-header-actions a {
      width: 32px;
      height: 32px;
      display: grid;
      place-items: center;
    ...
    #${APP_ID} .iu-header-actions button:hover, #${APP_ID} .iu-header-actions a:hover {
      background: var(--iu-bg-2);
      color: var(--iu-text);
      transform: translateY(-1px);
    }
    #${APP_ID} .iu-header-actions button[data-action="minimize"],
    #${APP_ID} .iu-header-actions button[data-action="close"] {
      background: rgba(255, 255, 255, 0.03);
      border: 1px solid var(--iu-line);
    }
    #${APP_ID} .iu-header-actions button[data-action="minimize"]:hover,
    #${APP_ID} .iu-header-actions button[data-action="close"]:hover {
    ...
    @keyframes pulseGlow {
      0% { transform: scale(1); box-shadow: 0 10px 25px rgba(168, 85, 247, 0.3); }
      100% { transform: scale(1.05); box-shadow: 0 15px 35px rgba(168, 85, 247, 0.5); }
    }
    ...
    #${APP_ID} .iu-welcome h2 { margin: 0; font-size: 20px; font-weight: 800; letter-spacing: -0.02em; }
    #${APP_ID} .iu-welcome p { margin: 0; color: var(--iu-muted); font-size: 13.5px; line-height: 1.55; max-width: 350px; }
    ...
    #${APP_ID} .iu-btn:hover:not(:disabled) {
      ...
      box-shadow: 0 6px 12px rgba(168, 85, 247, 0.12);
    }
    #${APP_ID} .iu-btn:active:not(:disabled) { transform: translateY(0px); }
    ...
    #${APP_ID} .iu-btn--danger:hover:not(:disabled) { background: #dc2626; border-color: #dc2626; }
    #${APP_ID} .iu-btn--ghost { background: transparent; box-shadow: none; border-color: transparent; }
    #${APP_ID} .iu-btn--ghost:hover:not(:disabled) { background: var(--iu-bg-2); border-color: var(--iu-line); }
    #${APP_ID} .iu-btn--lg { padding: 14px 28px; font-size: 15px; border-radius: 14px; margin-top: 10px; width: 100%; }
    #${APP_ID} .iu-btn--small { padding: 8px 14px; font-size: 12px; border-radius: 10px; }

    #${APP_ID} .iu-progress { padding: 36px 24px; display: flex; flex-direction: column; gap: 20px; }
    #${APP_ID} .iu-progress-head h2 { margin: 0; font-size: 16.5px; font-weight: 800; letter-spacing: -0.01em; }
    #${APP_ID} .iu-progress-head p { margin: 5px 0 0; color: var(--iu-muted); font-size: 13px; min-height: 1.2em; }
    
    /* REDESIGN: SEGMENTED LASER DIODES PROGRESS BAR */
    #${APP_ID} .iu-bar {
      height: 12px;
      border-radius: 99px;
      background: rgba(255, 255, 255, 0.03);
    ...
    #${APP_ID} .iu-bar > span {
      display: block;
      height: 100%;
      background: repeating-linear-gradient(90deg, #0052d4, #0052d4 4px, #4364f7 4px, #4364f7 8px, transparent 8px, transparent 12px);
    ...
    #${APP_ID} .iu-current strong { font-weight: 700; color: var(--iu-accent-2); }
    ...
    #${APP_ID} .iu-search:focus {
      ...
      background: var(--iu-bg-solid);
      box-shadow: 0 0 0 3px rgba(99, 102, 241, 0.15);
    }
    #${APP_ID} .iu-search::-webkit-search-cancel-button { filter: invert(0.5); }
    ...
    #${APP_ID} .iu-list::-webkit-scrollbar { width: 6px; }
    #${APP_ID} .iu-list::-webkit-scrollbar-track { background: transparent; }
    #${APP_ID} .iu-list::-webkit-scrollbar-thumb {
      background: var(--iu-line);
      border-radius: 10px;
    }
    #${APP_ID} .iu-list::-webkit-scrollbar-thumb:hover { background: var(--iu-muted); }
    ...
    /* REDESIGN: USER CARD GROUPS INSTEAD OF STANDARD ROW LIST */
    #${APP_ID} .iu-row {
      display: grid;
      ...
      align-items: center;
      cursor: pointer;
      border: 1px solid var(--iu-line) !important;
      border-radius: 14px;
    ...
    #${APP_ID} .iu-row:hover {
      background: var(--iu-bg-2);
      border-color: var(--iu-line-strong) !important;
      transform: translateY(-1px);
    }
    #${APP_ID} .iu-row:focus-visible { outline: none; border-color: var(--iu-accent) !important; }
    #${APP_ID} .iu-row--selected {
      background: rgba(99, 102, 241, 0.07);
      border-color: rgba(99, 102, 241, 0.3) !important;
    }
    #${APP_ID} .iu-row--selected:hover { background: rgba(99, 102, 241, 0.1); }
    ...
    #${APP_ID} .iu-row-name a:hover { color: var(--iu-accent-2); text-decoration: underline; }
    #${APP_ID} .iu-row-sub {
      font-size: 11.5px;
      color: var(--iu-muted);
      white-space: nowrap;
    ...
    #${APP_ID} .iu-icon-btn:hover { background: var(--iu-bg-3); color: var(--iu-text); border-color: var(--iu-line-strong); transform: scale(1.03); }
    #${APP_ID} .iu-text-btn {
      width: auto;
      padding: 0 10px;
      font-size: 11.5px;
    ...
    #${APP_ID} .iu-tag--blue { background: rgba(99, 102, 241, 0.08); border-color: rgba(99, 102, 241, 0.25); color: var(--iu-accent-2); }
    #${APP_ID} .iu-tag--green { background: rgba(16,185,129,0.08); border-color: rgba(16,185,129,0.25); color: var(--iu-success); }
    #${APP_ID} .iu-tag--red { background: rgba(244,63,94,0.08); border-color: rgba(244,63,94,0.25); color: var(--iu-danger); }
    ...
    #${APP_ID} .iu-muted { color: var(--iu-muted); font-size: 12.5px; }
    ...
    #${APP_ID} .iu-dialog h3 { margin: 0 0 8px; font-size: 18px; font-weight: 800; letter-spacing: -0.01em; }
    #${APP_ID} .iu-dialog p { margin: 0 0 14px; color: var(--iu-muted); font-size: 13.5px; line-height: 1.55; }
    #${APP_ID} .iu-dialog-actions { display: flex; justify-content: flex-end; gap: 8px; margin-top: 18px; }
    #${APP_ID} .iu-dialog-actions [data-extra] { margin-right: auto; }
    
    #${APP_ID} .iu-form { display: grid; gap: 10px; max-height: 50vh; overflow-y: auto; padding-right: 4px; }
    #${APP_ID} .iu-field { display: grid; grid-template-columns: 1fr 110px; align-items: center; gap: 12px; font-size: 13px; color: var(--iu-text); font-weight: 600; }
    ...
    #${APP_ID} .iu-toast {
      ...
      pointer-events: none;
      animation: iu-pop 0.3s cubic-bezier(0.34, 1.56, 0.64, 1);
    }
    ...
    #${APP_ID} .iu-pill:hover { background: var(--iu-bg-2); transform: scale(1.03); }
    #${APP_ID} .iu-pill-dot {
      width: 10px;
      height: 10px;
      border-radius: 50%;
    ...
    #${APP_ID} .iu-pill-dot--active { background: var(--iu-accent-2); animation: iu-pulse 1.4s infinite; }
